...
uint8 Interface_crc_high_first(uint8 *ptr, uint8 len) {
  //  uint8 i;
  uint8 crc = 0x00; /*ï¿½ï¿½ï¿½ï¿½Ä³ï¿½Ê¼crcÖµ*/

  while (len--) {
    crc ^=
        *ptr++; /*Ã¿ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Òªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ò£¬¼ï¿½ï¿½ï¿½ï¿½ï¿½Ö¸ï¿½ï¿½ï¿½ï¿½Ò»ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½*/
    //    for(i=8;i>0;--i)/*ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½8Î»ï¿½ï¿½ï¿½ï¿½Òªï¿½ï¿½ï¿½ï¿½8ï¿½ï¿½*/
    //    {
    //      if(crc & 0x80)/*ï¿½Ð¶ï¿½ï¿½ï¿½ï¿½Î»ï¿½Ç·ï¿½Î?1*/
    //      {
    //        crc=(crc <<
    //        1)^(0x2F);/*ï¿½ï¿½ï¿½Î»Î?1ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ò»Î»ï¿½ï¿½È»ï¿½ï¿½ï¿½ï¿½0x2Fï¿½ï¿½ï¿?*/
    //      }
    //      else
    //      {
    //        crc=(crc <<
    //        1);/*ï¿½ï¿½ï¿½Î»Î?0ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Òªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ò»Î?*/
    //      }
    //    }
  }
  crc ^= 0x00; /*CRCï¿½ï¿½0x00ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?*/
  return (crc);
}
